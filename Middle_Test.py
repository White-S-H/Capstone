...
class ImageFilterProgram(QWidget):
    def __init__(self):
        ...
        # 초기 창 크기 조정
        self.setGeometry(500, 150, 1000, 800)  # x, y, width, height
        ...
        self.filter_button6 = QPushButton("Binarization Filter")
        self.filter_button6.clicked.connect(self.Binarization_filter)
        ...
        self.original_button.clicked.connect(self.restore_original_image)
        ...
        '''
        # 버튼의 크기 고정
        self.load_button.setFixedSize(500, 10)
        self.filter_button.setFixedSize(500, 10)
        self.filter_button1.setFixedSize(500, 10)
        self.filter_button2.setFixedSize(500, 10)
        self.filter_button3.setFixedSize(500, 10)
        self.filter_button4.setFixedSize(500, 10)
        self.filter_button5.setFixedSize(500, 10)
        self.filter_button6.setFixedSize(500, 10)
        self.filter_button7.setFixedSize(500, 10)
        self.original_button.setFixedSize(500, 10)
        self.analyze_button.setFixedSize(500, 10)
        '''
    ...
    def load_image(self):
        ...
        if file_path:
            ...
            self.original_image = self.image.copy()  # 원본 이미지 복사
            self.display_image()
